...
func TestFilter(t *testing.T) {
	...
	t.Run("test filter stock", func(t *testing.T) {
	...
	t.Run("test filter prosentage", func(t *testing.T) {
	...
	t.Run("test filter point", func(t *testing.T) {
	...
	t.Run("test filter last review", func(t *testing.T) {
	...
	t.Run("test filter last login", func(t *testing.T) {
	...
	t.Run("test filter blacklist", func(t *testing.T) {
